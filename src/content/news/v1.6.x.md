...
description: strichliste v1.6.1 adds charging your account via PayPal, moves the config to a separate strichliste.yaml and brings many visual fixes.
---

We're proud to announce the new strichliste release v1.6.1 with a lot of fixes and some new features:
